...
\begin{itemize}
	...
	\item i professori hanno la possibilit\'a\ di accederea diverse sezioni d sito come le graduatorie di istituito(gli insegnanti visualizzano quali classi gli sono state assegnate). 
\end{itemize}
